...
def u():
	F();A('\x1b[96mChecking the status of the tool\x1b[0m');A(B);G.sleep(1);A('\x1b[94mCheck availability of tool\x1b[0m');C=r.get('https://bombtoolactive.onrender.com/status')
